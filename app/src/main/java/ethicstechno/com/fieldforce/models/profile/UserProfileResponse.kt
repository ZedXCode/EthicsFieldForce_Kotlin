...
data class UserProfileResponse(
    ...
    @SerializedName("PersonalEmailId") val personalEmailId: String = "",
    @SerializedName("PersonalMobileNo") val personalMobileNo: String = "",
    @SerializedName("Password") val password: String = "",
    @SerializedName("IsActive") val isActive: Boolean?,
    @SerializedName("IsDeleted") val isDeleted: Boolean?,
    @SerializedName("CommandId") val commandId: String?,
    @SerializedName("CreateBy") val createdBy: String?,
    ...
    @SerializedName("LastLoginDateTime") val lastLoginDateTime: String?,
    @SerializedName("Success") val success: Boolean?,
    @SerializedName("ReturnMessage") val returnMessage: String?,
    @SerializedName("PhoneModelNo") val phoneModelNo: String?,
    @SerializedName("PhoneBrandName") val phoneBrandName: String?,
    @SerializedName("PhoneOSVersion") val phoneOSVersion: String?,
    @SerializedName("BatteryPercentage") val batteryPercentage: String?
)

...
//    @SerializedName("ExpenseRejectRemarks") val expenseRejectRemarks: String?,
   ...
   // @SerializedName("ExpenseTypeName") val expenseTypeName: String?,
    ...
    @SerializedName("companyMasterId") val companyTypeName: Int?,
    @SerializedName("branchMasterId") val branchTypeName: Int?,
    @SerializedName("divisionMasterId") val divisionTypeName: Int?,
   ...
   // @SerializedName("CityCategoryName") val cityCategoryName: String?,
    ...
    @SerializedName("categoryMasterId") val categoryTypeName: Int?

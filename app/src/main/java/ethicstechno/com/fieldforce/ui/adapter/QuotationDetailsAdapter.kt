...
class QuotationDetailsAdapter(
    var mContext: Context,
    var productModelLis: List<ProductQuotationGroupResponse>,
    private val listener: ProductItemClickListener,
) :
    RecyclerView.Adapter<QuotationDetailsAdapter.ViewHolder>() {

    fun refreshAdapter(listdata: ArrayList<ProductQuotationGroupResponse>) {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        val item: ProductQuotationGroupResponse = productModelLis[position]
    ...
    interface ProductItemClickListener {
        fun onEditClick(item: ProductQuotationGroupResponse, position: Int)
        fun onDeleteClick(item: ProductQuotationGroupResponse, position: Int)
    }
